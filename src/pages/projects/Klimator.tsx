...
const styles = `
  ...
  .project h1 { margin: 0 0 2rem; font-size: 13px; font-weight: 500; }
  .project .lede { margin: 0 auto 3rem; color: #6b5840; max-width: 30rem; }
`

export default function Klimator() {
  useEffect(() => {
    const prevTitle = document.title
    document.title = 'klimator · Harun Abdi'
  ...
  return (
    <div className="project">
      ...
      <h1>klimator</h1>
      <p className="lede">FTP security work using inotify to watch the filesystem for unauthorized changes and intrusions in real time.</p>
    </div>
  )
}
