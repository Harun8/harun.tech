...
export default function Dovento() {
  useEffect(() => {
    const prevTitle = document.title
    document.title = 'dovento · Harun Abdi'
  ...
  return (
    <div className="project">
      ...
      <p className="lede">Hired in to create a frontend web application based on their existing native mobile app.</p>
    </div>
  )
}
